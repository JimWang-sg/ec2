...
#安装模块
pip install pandas akshare matplotlib requests mplfinance websockets jupyterlab-language-pack-zh-CN python-okx jupyter_ai openai pandas_ta yfinance ta
